...
double CarRentalSystem::calculateDynamicPricing(Vehicle *vehicle, const std::string &startDate, const std::string &endDate)
{
    double basePrice = vehicle->getDailyRate();
    int rentalDuration = calculateRentalDuration(startDate, endDate);
    double demandMultiplier = 1.2; // Example: 20% higher demand
    return basePrice * rentalDuration * demandMultiplier;
}

// Helper method to calculate rental duration in days
int CarRentalSystem::calculateRentalDuration(const std::string &startDate, const std::string &endDate)
{
...
double CarRentalSystem::applyLoyaltyDiscount(const Customer &customer, double totalCost)
{
...
// Super complex method for renting a vehicle
void CarRentalSystem::rentVehicleComplex(const Customer &customer, Vehicle *vehicle, const std::string &startDate, const std::string &endDate)
{
